...
- 150 deterministic TypeScript-reference fixtures replayed through the Java plugin copy.
...
The command above passed on 2026-07-12: 384 tests, 383 passed, 0 failures, and 1 opt-in high-volume seeded fuzz test skipped. This standalone build runs the included deterministic suite; it does not complete the opt-in high-volume seeded fuzz campaign.
...
- Standalone replay against 150 parent-generated reference fixtures pinned to `b6bc098d`
