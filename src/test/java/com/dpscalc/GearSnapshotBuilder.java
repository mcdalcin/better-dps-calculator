...
/**
 * Fluent builder for creating GearSnapshot instances in tests.
 * Follows the TestUtils.PlayerStateBuilder pattern with method chaining.
 * 
 * <p>Key features:
 * <ul>
 ...
 *     .withEquipment(EquipmentSlot.WEAPON.getIndex(), 12345, "Abyssal whip")
...
public class GearSnapshotBuilder {
     ...
     * 
     * <p>Example: Toggle prayer on existing snapshot
     * <pre>
     * GearSnapshot updated = new GearSnapshotBuilder()
     *     .copyFrom(existing)
     *     .withPrayers(Prayer.PIETY, Prayer.RIGOUR)
     ...
     * @return this builder for chaining
     * @throws IllegalArgumentException if arrays are not length 14
     */
